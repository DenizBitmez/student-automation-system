...
namespace StudentManagementApi.Migrations
{
    ...
    [Migration("20260108220928_ExamMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentManagementApi.Domain.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StudentManagementApi.Domain.ExamResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StudentManagementApi.Domain.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StudentManagementApi.Domain.QuestionOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StudentManagementApi.Domain.StudentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ExamResultId")
                        .HasDatabaseName("ix_student_answers_exam_result_id");
            ...
            modelBuilder.Entity("StudentManagementApi.Domain.ExamResult", b =>
                {
                    b.HasOne("StudentManagementApi.Domain.Exam", "Exam")
                        .WithMany("Results")
            ...
            modelBuilder.Entity("StudentManagementApi.Domain.QuestionOption", b =>
                {
                    b.HasOne("StudentManagementApi.Domain.Question", "Question")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("StudentManagementApi.Domain.StudentAnswer", b =>
                {
                    b.HasOne("StudentManagementApi.Domain.ExamResult", "ExamResult")
                        .WithMany("Answers")
                        .HasForeignKey("ExamResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_student_answers_exam_results_exam_result_id");
                    ...
                    b.HasOne("StudentManagementApi.Domain.QuestionOption", "SelectedOption")
                        .WithMany()
                        .HasForeignKey("SelectedOptionId")
                        .HasConstraintName("fk_student_answers_question_options_selected_option_id");
